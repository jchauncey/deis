...
COMPONENTS=builder controller database logger logspout publisher registry riemann router $(STORE_IF_STATEFUL)
START_ORDER=riemann publisher $(STORE_IF_STATEFUL) logger logspout database registry controller builder router
